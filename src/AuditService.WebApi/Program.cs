...
builder.Configuration.AddJsonFile("appsettings.base.json");
...
builder.Configuration.AddJsonFile("config/aus.api.appsettings.json", "config/appsettings.json", builder.Environment);
