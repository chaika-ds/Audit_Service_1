...
docker exec -it kafka kafka-topics --bootstrap-server localhost:9092 --create --topic dev.health-check
docker exec -it kafka kafka-topics --bootstrap-server localhost:9092 --create --topic dev.sso.blocked-players-log
...
docker exec -it kafka kafka-topics --bootstrap-server localhost:9092 --create --topic dev.sso.visit-log
docker exec -it kafka kafka-topics --bootstrap-server localhost:9092 --create --topic dev.localization.changed